...
//    console.log('Hello');
    ...
    specialTeam.push(current_pokemon);
//    current_pokemon['team'] = {id: teamNumber, 'name': teamNaming(teamNumber) };
    current_pokemon = JSON.stringify(current_pokemon);
...
$(document).on('click', '#playThisTeamButton', function() {
    ...
    $.each(teamPokemon, function(index, poke) {
        console.log(poke);
